                ...
                <motion.div
                  ...
                  className={`p-7 rounded-3xl border cursor-pointer transition-all duration-300 relative overflow-hidden group shadow-2xl backdrop-blur-xl ${
                    isDone
                      ...
                      : `bg-[#141414]/95 hover:bg-[#1E1E1E] border-[#333333] hover:${theme.border}`
                  }`}
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      >
                        {isDone ? (
                          ...
                          <Circle className="w-6 h-6 text-[#444444] hover:text-indigo-400" />
                        )}
                      </button>
                    </div>
                    ...
                    <p className="text-xs text-[#c9d1d9] leading-relaxed line-clamp-2 bg-[#1E1E1E]/70 p-3 rounded-2xl border border-[#2C2C2C]">
                      {step.description}
                    </p>
                          ...
                          {isExpanded && (
                            ...
                            >
                              {step.submodules.map((sub, sIdx) => (
                                <div
                                  key={sIdx}
                                  className="text-xs text-[#F4F4F5] bg-[#1E1E1E] border border-[#2C2C2C] px-3 py-2 rounded-xl flex items-center gap-2"
                                >
