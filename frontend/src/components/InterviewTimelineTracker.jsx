...
export default function InterviewTimelineTracker({ totalTrackProblems = 50, solvedCount = 0, companyName = null }) {
  ...
  return (
    <div className="dash-card relative overflow-hidden bg-[#121215] border border-[#27272A] rounded-2xl p-5 hover:border-zinc-500 transition-all shadow-sm">
      {/* Header Bar */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full py-2 px-3 bg-[#121215] dark:bg-[#121215] light:bg-white border border-zinc-800 dark:border-zinc-800 light:border-slate-300 rounded-lg text-xs text-zinc-100 dark:text-zinc-100 light:text-slate-900 focus:outline-none focus:border-[#EA5D3A]"
                >
                  {companiesData.map(c => (
