    ...
    <div className="dash-card p-6 bg-gradient-to-br from-[#161b22] via-[#1c2128] to-[#0d1117] border border-[#30363d] rounded-2xl shadow-xl relative overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold text-[#22c55e] uppercase tracking-widest bg-[#22c55e]/10 border border-[#22c55e]/20 px-2 py-0.5 rounded-full">
            ...
            <h2 className="text-xl font-extrabold text-white mt-0.5 flex items-center gap-2">
              Target: <span className="text-emerald-400">{targetCompany}</span> ({targetRole})
            </h2>
          </div>
        </div>
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-[#21262d] hover:bg-[#30363d] text-white text-xs font-semibold flex items-center gap-1.5 border border-[#30363d] transition-all"
        >
          {isEditing ? <X className="w-3.5 h-3.5" /> : <Edit3 className="w-3.5 h-3.5 text-emerald-400" />}
        ...
        {isEditing && (
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full py-2 px-3 bg-[#161b22] border border-[#30363d] rounded-xl text-xs text-white focus:outline-none focus:ring-2 focus:ring-[#22c55e]"
                >
                  {companiesData.map(c => (
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={handleSave}
                className="px-5 py-2 bg-[#22c55e] hover:bg-[#16a34a] text-white text-xs font-bold rounded-xl transition-all shadow-lg shadow-[#22c55e]/20"
              >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="p-4 rounded-xl bg-[#0d1117]/80 border border-emerald-500/30 flex items-center gap-3 relative overflow-hidden bg-gradient-to-r from-[#22c55e]/10 to-transparent">
          <div className="p-2.5 rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
            <Flame className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider">Daily Target Quota</p>
            <p className="text-xl font-black text-white">{dailyQuota} <span className="text-xs font-semibold text-emerald-400">/ day</span></p>
          </div>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between text-xs mb-1.5">
          ...
          <span className="font-mono font-bold text-emerald-400">{solvedCount} / {totalTrackProblems} Solved</span>
        </div>
        <div className="progress-track h-2 bg-[#0d1117] rounded-full overflow-hidden border border-[#30363d]">
          <div
            className="progress-fill h-full bg-gradient-to-r from-emerald-500 to-teal-400 transition-all duration-700"
