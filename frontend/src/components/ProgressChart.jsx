      ...
      <div className="p-5 flex flex-col sm:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="relative h-36">
            {/* Y-axis labels */}
            <div className="absolute left-0 top-0 bottom-5 flex flex-col justify-between text-[10px] text-[#737373] font-medium w-8">
        ...
        <div className="flex flex-row sm:flex-col items-center justify-center gap-4 sm:gap-3 sm:w-40 flex-shrink-0">
          ...
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-[10px] text-[#A3A3A3] font-medium">Today</span>
            </div>
          </div>
          {/* Legend */}
          <div className="space-y-1.5 text-xs">
            ...
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-[#2C2C2C] flex-shrink-0"></span>
              <span className="text-[#A3A3A3] font-medium">{remaining} Remaining</span>
            </div>
            <p className="text-[10px] text-[#737373] pt-1">Daily Target: {dailyTarget}</p>
          </div>
        </div>
      </div>
    </div>
