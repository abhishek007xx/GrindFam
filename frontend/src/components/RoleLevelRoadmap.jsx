...
export default function RoleLevelRoadmap({ companyName = 'Company' }) {
  ...
  return (
    <div className="dash-card p-6 bg-[#161b22] border border-[#30363d] rounded-2xl shadow-xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-4 border-b border-[#21262d]">
        <div>
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === 'campus' && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Month 1 */}
              <div className="p-4 rounded-xl bg-[#0d1117] border border-emerald-500/30 space-y-3 relative overflow-hidden">
              ...
              {/* Month 2 */}
              <div className="p-4 rounded-xl bg-[#0d1117] border border-indigo-500/30 space-y-3 relative overflow-hidden">
              ...
              {/* Month 3 */}
              <div className="p-4 rounded-xl bg-[#0d1117] border border-amber-500/30 space-y-3 relative overflow-hidden">
