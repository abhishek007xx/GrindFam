...
const StatsCards = ({ stats, dailyTarget = 5, onEditTarget }) => {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      ...
      {/* Hit Target Today */}
      <div className="dash-card dash-card-hover p-5">
        <div className="w-9 h-9 rounded-xl bg-[#CC785C]/10 flex items-center justify-center mb-3">
      ...
      <div className="dash-card dash-card-hover p-5">
        <div className="w-9 h-9 rounded-xl bg-[#CC785C]/10 flex items-center justify-center mb-3">
          <Flame className="w-5 h-5 text-[#CC785C]" />
        </div>
      ...
      <div className="dash-card dash-card-hover p-5 col-span-2 lg:col-span-1 flex items-center gap-4">
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-[#8b949e] hover:text-[#CC785C] transition-colors"
          >
        ...
        <div className="relative w-16 h-16 flex-shrink-0">
          <svg viewBox="0 0 80 80" className="w-full h-full -rotate-90">
            ...
            <circle
              ...
              fill="none" stroke="#CC785C" strokeWidth="6"
              strokeLinecap="round"
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Target className="w-5 h-5 text-[#CC785C]" />
          </div>
        </div>
      </div>
    </div>
