...
const StatsCards = ({ stats, dailyTarget = 5, onEditTarget, onSyncLeetCode, refreshing }) => {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      {/* Squad Members */}
      <div className="dash-card dash-card-hover p-5 bg-[#121318] border border-[#27272A] rounded-2xl">
        <div className="w-8 h-8 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-3 text-zinc-400">
        ...
        <p className="text-[10px] text-zinc-500 mt-0.5">Active in squad</p>
      </div>
      ...
      {/* Your Today's Count */}
      <div className="dash-card dash-card-hover p-5 bg-[#121318] border border-[#27272A] rounded-2xl flex flex-col justify-between">
        <div>
          <div className="flex items-center justify-between mb-3">
            <div className="w-8 h-8 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-[#EA5D3A]">
      ...
      <div className="dash-card dash-card-hover p-5 bg-[#121318] border border-[#27272A] rounded-2xl">
        ...
        <p className="text-[10px] text-zinc-500 mt-0.5">All-time solved</p>
      </div>

      {/* Daily Target Card */}
      <div className="dash-card dash-card-hover p-5 bg-[#121318] border border-[#27272A] rounded-2xl col-span-2 lg:col-span-1 flex items-center gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-xs font-semibold text-zinc-400 mb-0.5">Daily Target</p>
          <h3 className="text-3xl font-bold text-white font-mono tracking-tight">{target}</h3>
          <p className="text-[10px] text-zinc-500 mb-2">problems / day</p>
          <button
