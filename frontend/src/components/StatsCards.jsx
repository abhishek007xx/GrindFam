...
const StatsCards = ({ stats, dailyTarget = 5, onEditTarget, onSyncLeetCode, refreshing }) => {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      {/* Squad Members */}
      <div className="dash-card dash-card-hover p-5 bg-[#1E1E1E] border border-[#333333] rounded-2xl shadow-sm">
      ...
      {/* Your Today's Count */}
      <div className="dash-card dash-card-hover p-5 bg-[#1E1E1E] border border-[#333333] rounded-2xl shadow-sm flex flex-col justify-between">
        <div>
      ...
      {/* Daily Target Card */}
      <div className="dash-card dash-card-hover p-5 bg-[#1E1E1E] border border-[#333333] rounded-2xl shadow-sm col-span-2 lg:col-span-1 flex items-center gap-3">
