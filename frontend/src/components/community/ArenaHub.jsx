      ...
      >
        ...
        <div className="max-w-md mx-auto">
          <motion.button
            ...
            aria-live="polite"
            className="w-full py-4 bg-[#EA5D3A] hover:bg-[#F2633F] text-white text-sm font-extrabold rounded-xl shadow-xl shadow-[#EA5D3A]/30 transition-all flex items-center justify-center gap-2 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
          >
            {isSearching ? (
              <>
