                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3 min-w-0 pr-2">
                      ...
                      <div className="w-11 h-11 rounded-lg bg-[#18181B] border border-[#27272A] p-1.5 flex items-center justify-center overflow-hidden flex-shrink-0 group-hover:scale-105 transition-transform bg-white/5">
                        <img
                          src={logoUrl}
                          alt={comp.name}
