...
import {
  ...
  GraduationCap, Building2, BookOpen, Layers, Target, Compass, Star, Check, Database, Cpu
} from 'lucide-react';
    ...
    <div className="page-shell">
      ...
      <div className="page-content">
        ...
        <main className="page-main-constrained space-y-8 animate-fadeIn">
          {/* Hero Banner Section */}
          <div className="relative overflow-hidden rounded-3xl bg-[#0d1117] border border-[#30363d] p-8 shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/40 via-purple-950/20 to-transparent pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredRoadmaps.map(rm => {
              ...
              const bannerImg = bannerImageMap[rm.id] || '/assets/roadmaps/dsa.png';
              ...
              return (
                ...
                >
                  <div>
                    {/* Realistic Banner Image */}
                    <div className="relative h-36 w-full overflow-hidden bg-[#0d1117]">
                      <img
                        src={bannerImg}
                        alt={rm.title}
                      ...
                      <div className="absolute top-3 left-3 flex items-center gap-2">
                        <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#0d1117]/80 text-[#22c55e] border border-[#22c55e]/30 backdrop-blur">
                          {rm.category}
                        </span>
                      </div>
                      ...
                      <button
                        ...
                        className={`absolute top-3 right-3 p-2 rounded-xl transition-all backdrop-blur ${
                          isFollowing
                            ? 'bg-[#22c55e] text-[#0e150e]'
                            : 'bg-[#0d1117]/80 text-[#8b949e] hover:text-white border border-[#30363d]'
                        }`}
