...
function RoadmapBadgeIcon({ roadmap }) {
  ...
  return (
    <div className="w-10 h-10 rounded-lg bg-[#262626] border border-[#333333] p-1.5 flex items-center justify-center overflow-hidden flex-shrink-0 group-hover:scale-105 transition-transform">
      {iconUrl ? (
        <img
          src={iconUrl}
          alt={roadmap.title}
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all whitespace-nowrap border ${
              selectedCategory === cat.id
                ? 'bg-[#262626] text-white border-[#EA5D3A] shadow-sm'
              ...
              {filteredRoadmaps.map((rm) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`group relative bg-[#1E1E1E] border rounded-lg p-5 transition-all duration-200 cursor-pointer flex flex-col justify-between ${
                      isActive
                        ? 'border-[#EA5D3A] shadow-md ring-1 ring-[#EA5D3A]/30'
                        : 'border-[#333333] hover:border-[#4B5563]'
                    }`}
                  >
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-md text-[11px] font-semibold border transition-colors flex items-center gap-1 ${
                          isActive
                            ...
                            : 'bg-[#1E1E1E] border-[#333333] text-[#9CA3AF] hover:text-white'
                        }`}
                      >
        ...
        <aside className="lg:col-span-4 space-y-4">
          {activeRoadmap ? (
            <>
              ...
              <div className="bg-[#1E1E1E] border border-[#333333] rounded-lg p-5 space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-[#2C2C2C]">
                  ...
                  <span className="text-[10px] font-mono text-[#9CA3AF] bg-[#262626] px-2 py-0.5 rounded border border-[#333333]">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="flex items-center gap-2.5 p-2.5 rounded-lg bg-[#141414] border border-[#2C2C2C]">
              ...
              <div className="bg-[#1E1E1E] border border-[#333333] rounded-lg p-5 space-y-4">
                <h3 className="text-xs font-bold text-[#F4F4F5] uppercase tracking-wider flex items-center gap-1.5 pb-3 border-b border-[#2C2C2C]">
                  <Layers className="w-3.5 h-3.5 text-[#EA5D3A]" />
                  Milestone Progress
                </h3>

                <div className="relative pl-5 space-y-4">
                  <div className="absolute left-[7px] top-2 bottom-2 w-0.5 bg-[#2C2C2C]" />
                    ...
                    <div key={stageIdx} className="relative">
                      <div className={`absolute -left-5 top-1 w-3 h-3 rounded-full border-2 ${
                        stage.status === 'completed'
                          ...
                          : stage.status === 'active'
                          ? 'bg-[#141414] border-[#EA5D3A] shadow-[0_0_6px_#EA5D3A]'
                          : 'bg-[#2C2C2C] border-[#333333]'
                      }`} />
                        ...
                        {stage.steps.map((step, idx) => (
                          <div
                            ...
                            className={`flex items-start gap-2 p-2 rounded-md text-xs transition-all ${
                              stage.status === 'completed'
                                ? 'bg-[#141414] border border-[#2C2C2C] text-[#9CA3AF]'
                                : stage.status === 'active'
                                ? 'bg-[#141414] border border-[#EA5D3A]/30 text-[#F4F4F5]'
                                : 'bg-[#141414] border border-[#2C2C2C] text-[#6B7280] opacity-60'
                            }`}
                          >
              ...
              {skillBreakdown.length > 0 && (
                <div className="bg-[#1E1E1E] border border-[#333333] rounded-lg p-5 space-y-3">
                  <h3 className="text-xs font-bold text-[#F4F4F5] uppercase tracking-wider pb-3 border-b border-[#2C2C2C]">
                    Skill Breakdown
                  </h3>
              ...
              <div className="bg-[#1E1E1E] border border-[#EA5D3A]/20 rounded-lg p-4 space-y-2">
            ...
            <div className="bg-[#1E1E1E] border border-[#333333] rounded-lg p-5 text-center space-y-2">
