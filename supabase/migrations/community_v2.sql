-- Migration: Community V2 Migration (Roles, DMs, Realtime & RLS Fixes)
...
-- 4. RLS fix for squad_messages (THIS IS WHY CHAT IS DEAD)
...
-- 5. Enable realtime (wrapped in exception blocks so re-running won't error)
